...
%          Version 3.4   September 6, 2018 
%          (Job interruption control for 3D plot has been implemented 
%          by Takeshi Nogi)
%          Version 3.5   January 24, 2020
%          (A bug in specifying the frequency of injected wave 
%           has been fixed by Takeshi Nogi)
%          Version 3.6   August 11, 2020
%          (A bug in rescaling of k-spectrum has been fixed by Y. Omura)
%          Version 3.7   September 10, 2022
%          (A bug in plotting the Bz field has been fied by Y. Omura)
%
%
%          Copyright(c) 1993-2022, Space Simulation Group,
